...
import { ListFilter, HardDrive, Maximize2, X, Search, FileCheck } from 'lucide-react';
...
import { RelatorioEquipamentosView } from '../components/RelatorioEquipamentosView';
...
export const GestaoEquipamentosPage: React.FC = () => {
  ...
  const tabs = useMemo<TabItem<TabId>[]>(() => {
    ...
    return [
      ...
      { id: 'gestao_equip_relatorio', label: 'Relatório', enabled: true, icon: FileCheck }
    ];
  }, [dynamicTabs]);
  ...
  const isTabRelatorio =
    normalizedActiveTab.includes('relatorio') ||
    normalizedActiveTab === 'gestao_equip_relatorio';
  const isTabConsulta =
    !isTabRelatorio &&
      ...
      {isTabConsulta && (
        <div className="space-y-4 animate-slide-in">
          ...
          <FiltrosEquipamentos
            ...
            onConsultar={() => consultarEquipamentos()}
